...
<div class="aside">
  ...
  <ul class="nav">
    <li<?php echo $current_page === 'index' ? ' class="active"' : '' ?>>
      <a href="/baixiu/admin/index.php"><i class="fa fa-dashboard"></i>仪表盘</a>
    </li>
    ...
    <li<?php echo in_array($current_page, $menu_posts) ? ' class="active"' : '' ?>>
      ...
      <ul id="menu-posts" class="collapse<?php echo in_array($current_page, $menu_posts) ? ' in' : '' ?>">
        <li<?php echo $current_page === 'posts' ? ' class="active"' : '' ?>><a href="/baixiu/admin/posts.php">所有文章</a></li>
        <li<?php echo $current_page === 'post-add' ? ' class="active"' : '' ?>><a href="/baixiu/admin/post-add.php">写文章</a></li>
        <li<?php echo $current_page === 'categories' ? ' class="active"' : '' ?>><a href="/baixiu/admin/categories.php">分类目录</a></li>
      </ul>
    </li>
    <li<?php echo $current_page === 'comments' ? ' class="active"' : '' ?>>
      <a href="/baixiu/admin/comments.php"><i class="fa fa-comments"></i>评论</a>
    </li>
    <li<?php echo $current_page === 'users' ? ' class="active"' : '' ?>>
      <a href="/baixiu/admin/users.php"><i class="fa fa-users"></i>用户</a>
    </li>
    ...
    <li<?php echo in_array($current_page, $menu_settings) ? ' class="active"' : '' ?>>
      ...
      <ul id="menu-settings" class="collapse<?php echo in_array($current_page, $menu_settings) ? ' in' : '' ?>">
        <!--<li<?php echo $current_page === 'nav-menus' ? ' class="active"' : '' ?>><a href="/baixiu/admin/nav-menus.php">导航菜单</a></li>-->
        <li<?php echo $current_page === 'slides' ? ' class="active"' : '' ?>><a href="/baixiu/admin/slides.php">图片轮播</a></li>
        <li<?php echo $current_page === 'settings' ? ' class="active"' : '' ?>><a href="/baixiu/admin/settings.php">网站设置</a></li>
      </ul>
    </li>
  </ul>
</div>
